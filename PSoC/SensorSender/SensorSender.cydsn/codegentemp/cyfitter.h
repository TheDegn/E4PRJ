...
#define sensor_input_isr__INTC_MASK 0x01u
#define sensor_input_isr__INTC_NUMBER 0u
#define sensor_input_isr__INTC_PRIOR_NUM 7u
#define sensor_input_isr__INTC_PRIOR_REG CYREG_NVIC_PRI_0
...
#define CY_PROJECT_NAME "SensorSender"
