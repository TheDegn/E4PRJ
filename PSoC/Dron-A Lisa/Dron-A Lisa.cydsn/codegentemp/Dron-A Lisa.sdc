...
# Date: Tue, 12 Nov 2024 07:59:39 GMT
#set_units -time ns
create_clock -name {Clock_4(routed)} -period 83.333333333333329 -waveform {0 41.6666666666667} [list [get_pins {ClockBlock/dclk_1}]]
create_clock -name {Clock_2(routed)} -period 3003000 -waveform {0 1501500} [list [get_pins {ClockBlock/dclk_4}]]
...
create_generated_clock -name {Clock_2} -source [get_pins {ClockBlock/clk_sync}] -edges {1 72065 144145} [list [get_pins {ClockBlock/dclk_glb_4}]]
