...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=4294967293, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter_Sensor, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_Sensor, CY_INSTANCE_SHORT_NAME=Counter_Sensor, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Counter_Sensor, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=true, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=0, CompareType2Software=0, CompareValue1=1, CompareValue2=1, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=1, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=Sensor_Out, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Sensor_Out, CY_INSTANCE_SHORT_NAME=Sensor_Out, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Sensor_Out, )
module PWM_v3_30_3 (
    capture,
    clock,
    cmp_sel,
...
// CharLCD_v2_20(ConversionRoutines=false, CUSTOM0="C,12,12,C,0,0,0,0,", CUSTOM1="E,11,11,1F,1F,1B,1B,1F,", CUSTOM2="C,12,12,C,0,0,0,0,", CUSTOM3="E,11,1,1F,1F,1B,1B,1F,", CUSTOM4="6,4,6,4,4,E,A,E,", CUSTOM5="0,E,8,E,2,E,0,0,", CUSTOM6="0,E,8,E,2,E,0,0,", CUSTOM7="0,4,4,4,0,4,0,0,", CustomCharacterSet=3, TypeReplacementString=uint8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CharLCD_v2_20, CY_CONFIG_TITLE=LCD, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=LCD, )
module CharLCD_v2_20_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("5883e6f6-cc90-42cc-88d1-e292eb25a3fb/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_v3_10_5 (
	...
	cy_clock_v1_0
		#(.id("e1683f86-2874-435d-9010-221c678b3c0e/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
    ...
    PWM_v3_30_0 Motor_PWM (
        ...
        .tc(Net_241),
        .trigger(1'b0));
    defparam Motor_PWM.Resolution = 16;


	cy_clock_v1_0
		#(.id("5f191f2c-92d3-42fc-a908-dbaf12b2220e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("abd05c42-0b94-4e65-b14f-476150cca55b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Counter_v3_0_2 Counter_Sensor (
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam Counter_Sensor.CaptureMode = 0;
    defparam Counter_Sensor.ClockMode = 0;
    defparam Counter_Sensor.CompareMode = 1;
    defparam Counter_Sensor.CompareStatusEdgeSense = 1;
    defparam Counter_Sensor.EnableMode = 0;
    defparam Counter_Sensor.ReloadOnCapture = 0;
    defparam Counter_Sensor.ReloadOnCompare = 0;
    defparam Counter_Sensor.ReloadOnOverUnder = 1;
    defparam Counter_Sensor.ReloadOnReset = 1;
    defparam Counter_Sensor.Resolution = 32;
    defparam Counter_Sensor.RunMode = 0;
    defparam Counter_Sensor.UseInterrupt = 1;


	cy_clock_v1_0
		#(.id("76dee542-6369-41d3-ac06-f6f6818552fb"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Sensor_Input_net;
	wire [0:0] tmpIO_0__Sensor_Input_net;
	wire [0:0] tmpINTERRUPT_0__Sensor_Input_net;
	electrical [0:0] tmpSIOVREF__Sensor_Input_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Sensor_Input
		 (.oe(tmpOE__Sensor_Input_net),
		  .y({1'b0}),
		  .fb({Net_253}),
		  .io({tmpIO_0__Sensor_Input_net[0:0]}),
		  .siovref(tmpSIOVREF__Sensor_Input_net),
		  .interrupt({tmpINTERRUPT_0__Sensor_Input_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sensor_Input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("852056d3-18d8-49a1-9765-c369c4b86faf"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    PWM_v3_30_3 Sensor_Out (
        ...
        .tc(Net_426),
        .trigger(1'b0));
    defparam Sensor_Out.Resolution = 8;


	cy_clock_v1_0
		#(.id("222c8fe6-19bb-4b01-b648-a744c82c223c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("12500000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Sensor_Out_Pin_1_net;
	wire [0:0] tmpFB_0__Sensor_Out_Pin_1_net;
	wire [0:0] tmpIO_0__Sensor_Out_Pin_1_net;
	wire [0:0] tmpINTERRUPT_0__Sensor_Out_Pin_1_net;
	electrical [0:0] tmpSIOVREF__Sensor_Out_Pin_1_net;

	cy_psoc3_pins_v1_10
		#(.id("60180979-456a-4a04-9438-315125a07780"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sensor_Out_Pin_1
		 (.oe(tmpOE__Sensor_Out_Pin_1_net),
		  .y({Net_266}),
		  .fb({tmpFB_0__Sensor_Out_Pin_1_net[0:0]}),
		  .io({tmpIO_0__Sensor_Out_Pin_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Sensor_Out_Pin_1_net),
		  .interrupt({tmpINTERRUPT_0__Sensor_Out_Pin_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sensor_Out_Pin_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Sensor_Out_Pin_2_net;
	wire [0:0] tmpFB_0__Sensor_Out_Pin_2_net;
	wire [0:0] tmpIO_0__Sensor_Out_Pin_2_net;
	wire [0:0] tmpINTERRUPT_0__Sensor_Out_Pin_2_net;
	electrical [0:0] tmpSIOVREF__Sensor_Out_Pin_2_net;

	cy_psoc3_pins_v1_10
		#(.id("debd0e57-351b-404c-a3e5-693f14a23238"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sensor_Out_Pin_2
		 (.oe(tmpOE__Sensor_Out_Pin_2_net),
		  .y({Net_267}),
		  .fb({tmpFB_0__Sensor_Out_Pin_2_net[0:0]}),
		  .io({tmpIO_0__Sensor_Out_Pin_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Sensor_Out_Pin_2_net),
		  .interrupt({tmpINTERRUPT_0__Sensor_Out_Pin_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sensor_Out_Pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("bcddcbdf-ae6a-490d-87a4-68bfeb99dabd"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
