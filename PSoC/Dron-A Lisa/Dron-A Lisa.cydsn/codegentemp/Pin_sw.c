...
{
    uint8 staticBits = (Pin_sw_DR & (uint8)(~Pin_sw_MASK));
    Pin_sw_DR = staticBits | ((uint8)(value << Pin_sw_SHIFT) & Pin_sw_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pin_sw_0, mode);
}
...
{
    return (Pin_sw_PS & Pin_sw_MASK) >> Pin_sw_SHIFT;
}
...
{
    return (Pin_sw_DR & Pin_sw_MASK) >> Pin_sw_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Pin_sw_0_INTR) != 0u) 
		{ 
			 Pin_sw_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Pin_sw_INTSTAT & Pin_sw_MASK) >> Pin_sw_SHIFT;
    }
